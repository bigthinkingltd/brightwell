      ...
      <div className="flex flex-col min-h-screen px-2 md:px-10 gap-y-8 md:gap-y-20">
        ...
        <div className="flex flex-col items-center md:items-end gap-y-4">
          ...
          <div className="flex flex-row flex-wrap items-center justify-center md:justify-end gap-3 md:gap-4">
            ...
            <a
              className="flex justify-center w-32 h-16 md:w-44 md:h-20 items-center rounded-sm border border-white/20 bg-gradient-to-br from-[#1a1f3b] via-[#2e2a6b] to-[#4b3fa3] px-2 font-[cursive] text-sm md:text-base font-bold tracking-wider text-indigo-200 transition-colors duration-300 hover:border-[#e0b45b]"
              href="/recommended-texts"
            >
              Brightspell
            </a>
